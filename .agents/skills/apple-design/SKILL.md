---
name: apple-design
description: "Cross-platform UI/UX design reviewer grounded in Apple Human Interface Guidelines principles. Use this skill to audit, review, critique, or improve any UI/UX design for mobile apps (iOS, Flutter, React Native) or desktop apps (macOS, Tauri, Electron). Triggers when the user mentions design review, UI audit, HIG compliance, improving app design, design feedback, or accessibility audit, or asks to check or improve a design against professional standards. Also use when the user shares screenshots, mockups, wireframes, or design specs and wants feedback, including plain requests like 'review my design' or 'is this good UI'. Works with Flutter, Tauri, Electron, React Native, SwiftUI, and AppKit/UIKit."
---
